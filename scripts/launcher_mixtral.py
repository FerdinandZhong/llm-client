...
if __name__ == "__main__":
    ...
    # Add arguments
    parser.add_argument('--config_yaml_name', type=str, default="mixtral-chat-vllm",
                    help='mixtral model config yaml name')

    parser.add_argument('--log_file', type=str, default="mixtral")
